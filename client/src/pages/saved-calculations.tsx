    ...
    try {
        ...
        const editableData: EditableData = {
            ...
            businessParams: {
                ...
                lessorProfitMarginPct: fullData.businessParams?.lessorProfitMarginPct || 0,
                fixedMonthlyFee: fullData.businessParams?.fixedMonthlyFee || 0,
                adminCommissionPct: fullData.businessParams?.adminCommissionPct || 0,
                securityDepositMonths: fullData.businessParams?.securityDepositMonths || 0,
                deliveryCosts: fullData.businessParams?.deliveryCosts || 0,
                residualValueRate: fullData.businessParams?.residualValueRate || 0,
                discountRate: fullData.businessParams?.discountRate || 6.0,
            }
        };
